...
<task type="auto">
  ...
  <files>TBD based on triage - likely R/ or tests/testthat/ files</files>
  <action>
...
Re-run the specific check or test that failed to confirm fix works.
  ...
  <done>
All FIX items are resolved or task was skipped because no fixes needed.
  </done>
</task>
...
- [ ] All FIX items resolved (or none needed)
