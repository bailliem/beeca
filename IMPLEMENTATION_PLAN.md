...
- Support for multiple contrasts (3+ arm trials)
- Optional subgroup display
...
**Features:**
- Standard GLM diagnostics extended for beeca
...
**Features:**
- Marginal risk comparison (bar chart or point range)
- Conditional effects across continuous covariates
- Individual treatment effect (ITE) distribution (histogram/density)
- Customizable themes
...
- [ ] Implement `plot.beeca()` S3 method
- [ ] Implement `plot_forest()`
- [ ] Add basic tests
...
- [ ] Add diagnostic warnings to `get_marginal_effect()`
- [ ] Improve validation error messages in `sanitize_model()`
- [ ] Add tests for error messages

### Sprint 3 (Weeks 5-6): Workflow Helpers
- [ ] Implement `beeca_fit()` convenience function
- [ ] Enhance `summary.beeca()` method
- [ ] Enhance `print.beeca()` method
...
1. **Usability:** Users can create publication-ready plots with single function call
